                    ...
                    <div class="form-section">
                        ...
                        <ul>
                            <li>
                                ...
                                Ilość worków:&nbsp <span class="summary--text" id="summaryBag"></span>&nbsp
                                o zawartości:&nbsp <span class="summary--text" id="summaryCategory"></span>
                            </li>

                            <li>
                                <span class="icon icon-hand"></span>
                               Dla fundacji:&nbsp <span class="summary--text" id="summaryInstitution"></span>
                            </li>
                        </ul>
                    </div>
