...
<section class="stats">
    <div class="container container--85">
        <div class="stats--item">
            ...
            <p>Tyle sześćdziesięciolitrowych worków rzeczy zostało przekazane dla fundacji dobroczynnych!</p>
        </div>

        <div class="stats--item">
            <em><c:out value="${dontationsSum}"/></em>
            <h3>Przekazanych darów</h3>
            <p>Tyle różnych darów zostało przekazanych dla fundacji dobroczynnych!</p>
        </div>
